        ...
        */
        ...
        if (root != null) {
            for (Element row : root.select("li")) {
                ...
                //src = src.replace("http://image.excite.co.jp/jp/akb48/image/smartphone/20160509/profile/thumb/", "http://cf.akb48.co.jp/image/smartphone/2017/profile/detail/");
                imageUrl = src;

                name = img.attr("alt");

                //Log.d(mTag, name + " / " + thumbnailUrl + " / " + profileUrl);
